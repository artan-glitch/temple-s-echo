      ...
      <div className="container px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <Link to="/" className="flex items-center gap-2">
            <img src={`${import.meta.env.BASE_URL}images/becker-logo-gold.svg`} alt="Becker Innovation" className="h-7 w-auto opacity-70 hover:opacity-100 transition-opacity" />
          </Link>
